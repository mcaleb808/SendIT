...
router.put('/api/v1/parcels/:id/location', Auth.verifyToken, ParcelControllers.adminEdit);
router.put('/api/v1/parcels/:id/status', Auth.verifyToken, ParcelControllers.adminEdit);
