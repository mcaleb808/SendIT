...
router.put('/api/v1/parcels/:id/location', _Auth2.default.verifyToken, _parcels2.default.changeLocation);
router.put('/api/v1/parcels/:id/status', _Auth2.default.verifyToken, _parcels2.default.changeStatus);
