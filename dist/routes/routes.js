...
router.get('/api/v1/admin/parcels/:id', _Auth2.default.verifyToken, _Auth2.default.checkUser, _parcels2.default.getOneParcelAdmin);
router.put('/api/v1/parcels/:id/edit', _Auth2.default.verifyToken, _Auth2.default.checkUser, _parcels2.default.adminEdit);
