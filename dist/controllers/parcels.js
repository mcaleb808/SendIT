...
var ParcelControllers = {
  ...
  changeStatus: async function changeStatus(req, res) {
  ...
  changeLocation: async function changeLocation(req, res) {
    var _Helper$validateLocat = _helper2.default.validateLocation(req.body),
